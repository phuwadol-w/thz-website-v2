...
import { Shield, Target, Heart, Award, CheckCircle, ArrowRight, Star } from "lucide-react";
            ...
            >
              <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                <Image
                  ...
                  alt="สนามเด็กเล่น THZ - อุปกรณ์สนามเด็กเล่นคุณภาพ"
                  width={600}
                  height={400}
            ...
            {[
              {
                name: "THZ Play",
                color: "#FF9800",
                description: "อุปกรณ์สนามเด็กเล่น สไลเดอร์ ชิงช้า ปีนป่าย เครื่องเล่นเสริมพัฒนาการเด็ก",
              },
              {
                name: "THZ Bench",
                color: "#2196F3",
                description: "ม้านั่งโรงเรียน ม้านั่งสนาม โต๊ะโรงอาหาร อุปกรณ์สำหรับสถานศึกษา",
              },
              {
                name: "THZ Furniture",
                color: "#8BC34A",
                description: "เฟอร์นิเจอร์สไตล์ Loft โต๊ะ เก้าอี้ ชั้นวาง ดีไซน์ทันสมัย",
              },
            ].map((brand, index) => (
              <motion.div
                key={index}
              ...
              >
                <h3 className="font-montserrat font-extrabold text-xl text-text-dark mb-3">
                  {brand.name}
                </h3>
                <p className="thai-text text-gray-600 leading-relaxed">
                  {brand.description}
                </p>
              </motion.div>
            ))}
