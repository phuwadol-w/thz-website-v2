            ...
            >
                ...
                {[
                  {
                    icon: Phone,
                    title: "โทรศัพท์",
                    content: "081-300-1932",
                    sub: "โทรเลย ไม่ต้องเกรงใจ",
                    href: "tel:0813001932",
                    color: "#2196F3",
                  },
                  {
                  ...
                  },
                  {
                    icon: Mail,
                    title: "อีเมล",
                    content: "THZ@gmail.com",
                    sub: "ส่งรายละเอียดได้เลย",
                  ...
                  },
                  {
                    icon: MapPin,
                    title: "ที่อยู่",
                    content: "44 หมู่ 1 ถนนเทวบุรี",
                    sub: "ต.โพธิ์เสด็จ อ.เมือง จ.นครศรีธรรมราช 80000",
                    color: "#4CAF50",
                  },
                ].map((item, i) => (
                  <div key={i} className="flex items-start gap-4 group">
                    ...
                    <div>
                      <h3 className="font-montserrat font-bold text-text-dark mb-1">
                        {item.title}
                      </h3>
                      {item.href ? (
                        <a
                          ...
                          className="thai-text text-primary hover:underline font-medium"
                        >
                          {item.content}
                        </a>
                      ) : (
              ...
              <div className="bg-background-light rounded-2xl p-6">
                ...
                <div className="space-y-2 thai-text text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-text-dark">08:00 - 17:00</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">เสาร์</span>
                    <span className="font-medium text-text-dark">08:00 - 12:00</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">อาทิตย์</span>
                    <span className="text-gray-400">ปิดทำการ</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-3 mt-6">
                <a
                  ...
                  className="w-12 h-12 bg-primary rounded-xl flex items-center justify-center text-white hover:bg-primary-dark transition-all duration-300 hover:scale-110"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-[#06C755] rounded-xl flex items-center justify-center text-white hover:bg-[#05b34a] transition-all duration-300 hover:scale-110"
                >
              ...
              <div className="bg-white rounded-3xl p-8 md:p-10 shadow-xl border border-gray-100">
                ...
                {submitted ? (
                  ...
                  >
                    ...
                    <p className="thai-text text-gray-500">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                      <label className="thai-text block text-sm font-semibold text-gray-700 mb-2">
                        ชื่อ-นามสกุล *
                      </label>
                      <input
                        type="text"
                        ...
                        className="w-full px-5 py-3.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary outline-none thai-text transition-all duration-300"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-5 py-3.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary outline-none thai-text transition-all duration-300 bg-white"
                      >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="กรอกรายละเอียด เช่น ขนาดพื้นที่ จำนวนที่ต้องการ งบประมาณ..."
                        className="w-full px-5 py-3.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary outline-none thai-text resize-none transition-all duration-300"
                      />
                    </div>

                    <button
                      type="submit"
                      className="w-full btn-cta flex items-center justify-center gap-2 text-base py-4"
                    >
                      <Send size={18} />
                      <span className="thai-text">ส่งข้อความ</span>
                    </button>

                    <p className="thai-text text-xs text-gray-400 text-center">
                      เราจะตอบกลับภายใน 24 ชม. ในวันทำการ
                    </p>
                  </form>
                )}
              </div>
      ...
      <section className="py-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          >
            ...
            <h2 className="font-montserrat text-2xl md:text-3xl font-extrabold text-text-dark">
              ที่ตั้งบริษัท
            </h2>
          </motion.div>
          <motion.div
          ...
          >
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1576.5!2d99.9464!3d8.4328!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3042a5c0c0c0c0c1%3A0x1234567890abcdef!2z44ijIDEg5LiD5oSf5YKr5rOV5Y2J5p2l6ZyA6ZmE5pyN5Yqh6KGo5aC0!5e0!3m2!1sth!2sth!4v1234567890!5m2!1sth!2sth"
              width="100%"
              height="400"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="ที่ตั้ง THZ - 44 หมู่ 1 ถนนเทวบุรี ต.โพธิ์เสด็จ อ.เมือง จ.นครศรีธรรมราช 80000"
              className="w-full"
            />
          </motion.div>
