...
import { Shield, Truck, Wrench, Phone, MessageCircle, Star, ArrowRight, Award, CheckCircle, Heart, Users } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="relative h-64 overflow-hidden">
                <Image
                  src="/images/brands/thz-play.jpg"
                  alt="THZ Play - อุปกรณ์สนามเด็กเล่น"
                  fill
                  className="object-cover group-hover:scale-110 transition-transform duration-700"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-text-dark/60 to-transparent" />
                <div className="absolute bottom-4 left-4">
                  <span className="inline-block bg-thz-play text-white text-xs font-bold px-4 py-1.5 rounded-full">
                    PLAYGROUND
                  </span>
                </div>
              </div>
              <div className="p-6">
                ...
                <p className="font-inter text-sm text-gray-500 mb-4 leading-relaxed">
                  สไลเดอร์ ชิงช้า ปีนป่าย เครื่องเล่นเสริมพัฒนาการเด็ก
                </p>
                <Link
                  href="/products?cat=play"
            ...
            >
              <div className="relative h-64 overflow-hidden">
                <Image
                  src="/images/brands/thz-bench.jpg"
                  alt="THZ Bench - ม้านั่งโรงเรียน"
                  fill
                  className="object-cover group-hover:scale-110 transition-transform duration-700"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-text-dark/60 to-transparent" />
                <div className="absolute bottom-4 left-4">
                  <span className="inline-block bg-thz-bench text-white text-xs font-bold px-4 py-1.5 rounded-full">
                    BENCH
                  </span>
                </div>
              </div>
            ...
            >
              <div className="relative h-64 overflow-hidden">
                <Image
                  src="/images/brands/thz-furniture.jpg"
                  alt="THZ Furniture - เฟอร์นิเจอร์ Loft"
                  fill
                  className="object-cover group-hover:scale-110 transition-transform duration-700"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-text-dark/60 to-transparent" />
                <div className="absolute bottom-4 left-4">
                  <span className="inline-block bg-thz-furniture text-white text-xs font-bold px-4 py-1.5 rounded-full">
                    FURNITURE
                  </span>
                </div>
              </div>
              <div className="p-6">
                ...
                <p className="font-inter text-sm text-gray-500 mb-4 leading-relaxed">
                  เฟอร์นิเจอร์สไตล์ Loft โต๊ะ เก้าอี้ ชั้นวาง ผลิตตามสั่ง
                </p>
                <Link
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="thai-text text-gray-500 max-w-2xl mx-auto">
              ผลิตจากวัสดุคุณภาพสูง โครงเหล็กชุบสังกะสี + พลาสติก LLDPE
              ทนทาน ปลอดภัย ได้มาตรฐาน มอก.3000
            </p>
            <div className="section-divider mt-6" />
          </motion.div>
      ...
      <section className="py-20 bg-background-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="font-montserrat text-3xl md:text-4xl font-extrabold text-text-dark mb-4">
              คุณภาพระดับโลก ราคาที่เข้าถึงได้
            </h2>
            <p className="thai-text text-gray-500 max-w-2xl mx-auto">
