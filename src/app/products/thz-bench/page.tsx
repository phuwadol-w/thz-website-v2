...
export const metadata: Metadata = {
  title: "THZ Bench - ม้านั่งโรงเรียนคุณภาพมาตรฐาน นครศรีธรรมราช",
  description:
    "ผู้ผลิตและจำหน่ายม้านั่งโรงเรียนคุณภาพ โครงเหล็กแข็งแรง ทนทาน ขนาดมาตรฐาน จัดส่งทั่วประเทศ บริการติดตั้งฟรี ☎️ 081-300-1932",
  keywords: [
    "ม้านั่งโรงเรียน",
    "ม้านั่งนักเรียน",
    "ม้านั่งสนาม",
    ...
    "ม้านั่งนักเรียน นครศรีธรรมราช",
    "ม้านั่งสนาม นครศรีธรรมราช",
    "ม้านั่งพลาสติก นครศรีธรรมราช",
    "โต๊ะเรียน นครศรีธรรมราช",
    "โต๊ะเก้าอี้โรงเรียน นครศรีธรรมราช",
    "เฟอร์นิเจอร์โรงเรียน นครศรีธรรมราช",
    "เฟอร์นิเจอร์เหล็ก นครศรีธรรมราช",
    "ม้านั่งโรงเรียนราคาถูก",
    "ม้านั่งโรงเรียนคุณภาพ",
    "ม้านั่งโรงเรียนมาตรฐาน",
    "ม้านั่งโรงเรียนปลอดภัย",
    "ม้านั่งโรงเรียนรับประกัน",
    "ม้านั่งโรงเรียนจัดส่งฟรี",
    "ม้านั่งโรงเรียนติดตั้งฟรี",
    "ม้านั่งสนาม ภาคใต้",
    "ม้านั่งโรงเรียน ภาคใต้",
    "โต๊ะเก้าอี้โรงเรียน ภาคใต้",
    "เฟอร์นิเจอร์โรงเรียน ภาคใต้",
    "ม้านั่งโรงเรียน สุราษฎร์ธานี",
    "ม้านั่งโรงเรียน สงขลา",
    "ม้านั่งโรงเรียน ภูเก็ต",
    "ม้านั่งโรงเรียน กระบี่",
    "ม้านั่งโรงเรียน ชุมพร",
    "ม้านั่งโรงเรียน ระนอง",
    "ม้านั่งโรงเรียน พังงา",
    "ม้านั่งโรงเรียน ตรัง",
    "ม้านั่งโรงเรียน สตูล",
    "ม้านั่งโรงเรียน ปัตตานี",
    "ม้านั่งโรงเรียน ยะลา",
    "ม้านั่งโรงเรียน นราธิวาส",
    "ผู้ผลิตม้านั่งโรงเรียน",
    "โรงงานม้านั่งโรงเรียน",
    "รับทำม้านั่งโรงเรียน",
    "ออกแบบม้านั่งโรงเรียน",
    "ขายม้านั่งโรงเรียน",
    "ผลิตม้านั่งโรงเรียน",
  ],
  alternates: {
