...
const defaultProducts = [
  { title: "สนามเด็กเล่นพลาสติกกันแดด", description: "สนามเด็กเล่นรวม โครงเหล็กชุบสังกะสี + พลาสติก LLDPE กันแดดกันฝน ปลอดภัยได้มาตรฐาน", image: "/images/products/726606443_1405968788229183_6337553449482275185_n.jpg", badge: "ยอดนิยม", accentColor: "#FF9800", category: "THZ Play" },
  { title: "สไลเดอร์พลาสติกพร้อมบันได", description: "สไลเดอร์พลาสติก LLDPE คุณภาพสูง พร้อมบันไดปีน ฐานมั่นคง ปลอดภัยสำหรับเด็ก", image: "/images/products/124374999_2742818269293265_2851804580300417570_n.jpg", accentColor: "#2196F3", category: "THZ Play" },
  { title: "ชิงช้าสนามพลาสติก", description: "ชิงช้าสนามโครงเหล็ก แข็งแรง ทนทาน เหมาะสำหรับโรงเรียน หมู่บ้าน เทศบาล", image: "/images/products/472772789_3852975844944163_5782975775520749990_n.jpg", accentColor: "#4CAF50", category: "THZ Play" },
  { title: "เครื่องเล่นรวมเสริมพัฒนาการ", description: "ชุดเครื่องเล่นรวม ปีนป่าย สไลเดอร์ ชิงช้า เสริมพัฒนาการเด็กทุกวัย", image: "/images/products/481072543_1171214081676927_1346842185356984644_n.jpg", badge: "ใหม่", accentColor: "#FF5722", category: "THZ Play" },
  { title: "ม้านั่งโรงเรียน", description: "ม้านั่งสนาม โครงเหล็กแข็งแรง ทนทาน ขนาดมาตรฐาน เหมาะสำหรับโรงเรียน", image: "/images/products/650721761_1321150026711060_532668979833544120_n.jpg", accentColor: "#2196F3", category: "THZ Bench" },
  { title: "เครื่องเล่นสนามกลางแจ้ง", description: "อุปกรณ์สนามเด็กเล่นกลางแจ้ง โครงเหล็กชุบสังกะสี ทนแดดทนฝน ติดตั้งทั่วประเทศ", image: "/images/products/769309563_1449583230534405_8478278305857454543_n.jpg", accentColor: "#FFC107", category: "THZ Play" },
];
...
const defaultBrands = [
  { name: "THZ Play", slug: "play", description: "สไลเดอร์ ชิงช้า ปีนป่าย เครื่องเล่นเสริมพัฒนาการเด็ก", image: "/images/brands/thz-play.jpg", color: "#2196F3", badge: "PLAYGROUND", link: "/products?cat=play" },
  { name: "THZ Bench", slug: "bench", description: "ม้านั่งโรงเรียน ม้านั่งสนาม โต๊ะโรงอาหาร", image: "/images/brands/thz-bench.jpg", color: "#4CAF50", badge: "BENCH", link: "/products?cat=bench" },
  { name: "THZ Furniture", slug: "furniture", description: "เฟอร์นิเจอร์สไตล์ Loft โต๊ะ เก้าอี้ ชั้นวาง ผลิตตามสั่ง", image: "/images/brands/thz-furniture.jpg", color: "#FF9800", badge: "FURNITURE", link: "/products?cat=furniture" },
];
...
export default function SectionRenderer({ sectionId, homepage }: SectionRendererProps) {
  const hp = homepage || {};

  switch (sectionId) {
    case "hero":
      return <HeroSection hp={hp} />;
    case "stats":
      return <StatsSection hp={hp} />;
    case "brands":
      return <BrandsSection hp={hp} />;
    case "products":
      return <ProductsSection hp={hp} />;
    case "gallery":
      return <GallerySection hp={hp} />;
    case "whyChooseUs":
      return <WhyChooseUsSection hp={hp} />;
    case "testimonials":
      return <TestimonialsSection hp={hp} />;
    case "cta":
      return <CTASection hp={hp} />;
    default:
      return null;
  }
}
